  ...
  return (
    <div>
      ...
      <main>
        ...
        <p>
          Découvrez Zorglux, votre destination ultime pour tout ce qui concerne
          Zorglub, l&apos;ennemi du héros Zurglux dans l&apos;anime célèbre.
          Plongez dans l&apos;univers fascinant de Zorglub, explorez ses
          aventures, et apprenez-en plus sur ce personnage emblématique.
        </p>
        ...
        <Image
          ...
          width={500}
          height={500}
          alt="Zorglub illustration"
        />
        <section>
          <h2>Nos Dernières Aventures</h2>
          <ul>
            <li>
              <a href="/blog/zorglub-vs-zurglux">
                Zorglub vs Zurglux: Une Bataille Épique
              </a>
            </li>
            <li>
              <a href="/blog/les-origines-de-zorglub">
                Les Origines de Zorglub
              </a>
            </li>
            <li>
              <a href="/blog/les-armes-de-zorglub">
                Les Armes Secrètes de Zorglub
              </a>
            </li>
          </ul>
        </section>
