...
export const metadata = {
  title: 'Zorglux Zorglub - Questions & Answers',
  keywords: "Zorglux, Zorglub, bande dessinée, page questions et réponses",
  author: "Zorglux Zorglub team",
  openGraph: {
    title: "Page questions et réponses - Zorglux",
    description: 'En savoir plus sur Zorglux et notre passion pour le monde de Zorglub.',
    type: 'website',
    url: 'https://zorglux-zorglub.com/faq',
    images: [
      {
